...
export function EventTypeCard({ eventType, onClick }: EventTypeCardProps) {
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center gap-4 p-4 text-left bg-surface-900 border border-surface-800 rounded-lg hover:border-primary-500/50 hover:-translate-y-0.5 transition-all duration-200"
    >
